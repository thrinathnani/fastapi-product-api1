...
app = FastAPI(
    ...
    description="Simple FastAPI project for managing store products",
    version="1.0"
)
...
def get_products_by_category(category_name: str):
    ...
    return {"category": category_name, "items": filtered}
@app.get("/products/in-stock")
def get_in_stock_products():
    in_stock_products = [p for p in products if p["in_stock"]]
    return {"total": len(in_stock_products), "items": in_stock_products}
